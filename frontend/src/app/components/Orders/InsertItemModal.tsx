    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <FontAwesomeIcon cursor={"pointer"} icon={faClose} />
          </Flex>
          <div
            style={{
              width: "100%",
            ...
            <Flex direction={'column'} style={{width: '100%'}}>
              <Flex>
                <Flex style={{gap: '12px'}} align={'center'}>
                  <label style={{display:'flex', justifyContent: 'center', height: '24px', width: '96px', cursor: 'pointer', borderStyle: 'solid', borderWidth: '1px', marginBottom: '6px', alignItems: 'center'}} className="" htmlFor="file-upload">
                    <FontAwesomeIcon
                      icon={faImage}
